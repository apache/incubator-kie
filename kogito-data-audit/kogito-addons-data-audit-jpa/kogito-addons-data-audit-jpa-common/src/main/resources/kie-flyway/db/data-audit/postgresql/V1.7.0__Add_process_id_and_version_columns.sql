...
CREATE INDEX IF NOT EXISTS ix_utsl_rproc_id  ON Task_Instance_State_Log (root_process_id);
CREATE INDEX IF NOT EXISTS ix_utsl_proc_ver  ON Task_Instance_State_Log (process_version);
CREATE INDEX IF NOT EXISTS ix_utsl_rproc_ver ON Task_Instance_State_Log (root_process_version);
