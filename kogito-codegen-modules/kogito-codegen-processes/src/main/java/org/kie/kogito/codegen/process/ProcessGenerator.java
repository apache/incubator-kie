...
public class ProcessGenerator {
    ...
    public ClassOrInterfaceDeclaration classDeclaration() {
        ...
        // Attach the per-node and per-connection helper methods generated by ProcessVisitor.
        // Each helper is a private static void method containing only the statements for one
        // node or one connection, so no individual method can approach the JVM 64KB limit.
