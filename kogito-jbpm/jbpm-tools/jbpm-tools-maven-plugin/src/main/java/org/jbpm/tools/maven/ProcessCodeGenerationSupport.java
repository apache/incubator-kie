...
public class ProcessCodeGenerationSupport {
    ...
    private void addMembers(ProcessMetaData processMetaData, CompilationUnit compilationUnit) {
        ...
        // Add the per-node and per-connection helper methods generated by ProcessVisitor so
        // that the initNode_*/initConnection_* calls in process() resolve at compile time.
